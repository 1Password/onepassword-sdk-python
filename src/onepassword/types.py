...
class ItemField(BaseModel):
    ...
    """
    All the details of the field value, for more complex fields.
    """


class ItemFieldDetailsOtp(BaseModel):
    type: Literal["Otp"]
    content: OtpItemFieldDetails


class ItemFieldDetailsSSHKey(BaseModel):
    type: Literal["SSHKey"]
    content: SSHKeyItemFieldDetails


ItemFieldDetails = ItemFieldDetailsOtp | ItemFieldDetailsSSHKey
...
class OtpItemFieldDetails(BaseModel):
    totp: str
    seed: str


class SSHKeyItemFieldDetails(BaseModel):
    private_key: str
    public_key: str
    key_type: str
    fingerprint: str
